def laberinto():
    laberinto = {
        ...
        "pasillo": {"norte": "salida", "sur": "entrada", "este": "cuarto oscuro", "oeste": "cuarto blanco"},
        "cuarto blanco": {"norte": "cuarto rojo", "sur": None, "este": "pasillo", "oeste":None},
        "cuarto rojo": {"norte":None, "sur":"cuarto blanco", "este":"salida", "oeste":None },
        "cuarto oscuro": {"norte":None, "sur":None, "este":None, "oeste":"pasillo"},
        "salida": {"norte": None, "sur": "pasillo", "este": None, "oeste": "cuarto rojo"},
    }
